webpackJsonp([1],Array(314).concat([
/* 314 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__survey_list__ = __webpack_require__(461);
        ...
        this.dataService.postData("allSurveys", {
            ...
            if (results.success == true) {
                ...
                _this.survey_list.forEach(function (element) {
                    element.effectiveTo = __WEBPACK_IMPORTED_MODULE_2_moment__(element.effectiveTo).format('YYYY-MM-DD HH:mm');
