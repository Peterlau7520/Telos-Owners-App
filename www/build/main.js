...
var DataService = (function () {
    ...
    DataService.prototype.getData = function (q, headers) {
        return this.http.get(this.BASE_URL + q, headers)
            .map(function (results) { return results.json(); });
    };
    DataService.prototype.postData = function (q, object, headers) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_onesignal__ = __webpack_require__(160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_loading_service__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_data_service__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_show_message__ = __webpack_require__(106);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    function HomePage(platform, navCtrl, loadingService, dataService, showMessage, device, oneSignal, localNotifications) {
        var _this = this;
        ...
        platform.ready().then(function () {
            _this.oneSignal.startInit('72ae436c-554c-4364-bd3e-03af71505447', '709611482439');
    ...
    HomePage.prototype.doLoginFunction = function (form) {
        ...
        this.dataService.postData("login", form.value, {}).subscribe(function (results) {
            if (results.success == true) {
                ...
                if (results.user.registered == true) {
                    ...
                    localStorage.setItem("firstTabPage", "Noticeboard");
                    _this.navCtrl.push("Tabs").then(function () {
                        _this.loadingService.hideLoading();
                    });
                }
                else if (results.user.registered == false) {
                    if (results.user.nature == "CorporateOwner") {
                        _this.addOwnerInfoData(results.user.numberOfOwners);
                        _this.navCtrl.push("CompanyChop").then(function () {
                            _this.loadingService.hideLoading();
                        });
                    }
                    else {
                        _this.addOwnerInfoData(results.user.numberOfOwners);
                        _this.navCtrl.push("IdVerification1").then(function () {
                            _this.loadingService.hideLoading();
                        });
                    }
                }
            ...
            console.log("err", err);
            _this.loadingService.hideLoading();
            _this.showMessage.showToastBottom("Unable to login, please try again.");
        });
    };
    HomePage.prototype.addOwnerInfoData = function (numberOfOwners) {
        var owners_list = [];
        ...
        var tmp_owner_list = JSON.stringify(owners_list);
...
var map = {
	...
	"../pages/forum-details/forum-details.module": [
		303,
		19
	],
	"../pages/forum-page/forum-page.module": [
		304,
		18
	],
	"../pages/forum-post-modal/forum-post-modal.module": [
		305,
		17
	],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_signaturepad_signature_pad__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_device__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_local_notifications__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_camera__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_file_opener__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_in_app_browser__ = __webpack_require__(211);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_document_viewer__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_angular2_signaturepad__ = __webpack_require__(289);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_youtube_video_player__ = __webpack_require__(213);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_file_transfer__ = __webpack_require__(206);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__ionic_native_file__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__ionic_native_onesignal__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_screen_orientation__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__providers_show_message__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__providers_loading_service__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__providers_data_service__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__ionic_storage__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__app_component__ = __webpack_require__(294);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_home_home__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_signature_pad_page_signature_pad_page__ = __webpack_require__(212);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__providers_auth_auth__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__providers_meetings_meetings__ = __webpack_require__(296);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__providers_notices_notices__ = __webpack_require__(297);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_24__pages_signature_pad_page_signature_pad_page__["a" /* SignaturePadPage */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_22__app_component__["a" /* MyApp */], {
                    ...
                    links: [
                        ...
                        { loadChildren: '../pages/forum-details/forum-details.module#ForumDetailsModule', name: 'ForumDetails', segment: 'forum-details', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/forum-page/forum-page.module#ForumPageModule', name: 'ForumPage', segment: 'forum-page', priority: 'low', defaultHistory: [] },
                        { loadChildren: '../pages/forum-post-modal/forum-post-modal.module#ForumPostModalModule', name: 'ForumPostModal', segment: 'forum-post-modal', priority: 'low', defaultHistory: [] },
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_18__providers_show_message__["a" /* ShowMessage */],
                __WEBPACK_IMPORTED_MODULE_19__providers_loading_service__["a" /* LoadingService */],
                __WEBPACK_IMPORTED_MODULE_20__providers_data_service__["a" /* DataService */],
                ...
                __WEBPACK_IMPORTED_MODULE_26__providers_meetings_meetings__["a" /* MeetingsProvider */],
                __WEBPACK_IMPORTED_MODULE_27__providers_notices_notices__["a" /* NoticesProvider */]
            ],
...
var MyApp = (function () {
    ...
    MyApp.prototype.doLogout = function () {
        var _this = this;
        this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_4__pages_home_home__["a" /* HomePage */]).then(function () {
            _this.clearLocalStorage();
        });
    };
    MyApp.prototype.clearLocalStorage = function () {
