...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__company_chop__ = __webpack_require__(320);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_loading_service__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_data_service__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_show_message__ = __webpack_require__(104);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CompanyChop = (function () {
    ...
    CompanyChop.prototype.takePicture = function (sourceType) {
        ...
        this.camera.getPicture(options).then(function (imageData) {
            _this.id_image = 'data:image/png;base64,' + imageData;
    ...
    CompanyChop.prototype.goToRegister = function () {
        ...
        if (typeof this.id_image == "undefined" || this.id_image == "" || this.id_image == null) {
            ...
            this.dataService.postData("saveChop", request_data, {}).subscribe(function (results) {
